...
public class FestivalApp {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("20. Delete an event");
            System.out.println("30. Show events in ascending order of max capacity of student registration");
            ...
            switch (choice) {
                ...
                case 9:
                    ...
                    break;
                case  20:
                    System.out.print("Enter Events to be deleted");
                    String delEvent=scanner.nextLine();
                    festivalManager.deleteEvent(delEvent);
                    break;

                case 30:
                    festivalManager.showInOrderOfMaxCapacity();
                    break;
